...
const HeroSection = () => {
  return (
    <section className="relative bg-gradient-to-br from-cyan-50 via-white to-teal-50 dark:from-slate-900 dark:via-slate-800 dark:to-slate-900 py-20 lg:py-32 overflow-hidden">
      {/* Background Pattern */}
