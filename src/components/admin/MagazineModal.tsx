...
const MagazineModal = ({ isOpen, onClose, onSave, initialData }: MagazineModalProps) => {
  ...
  return (
    <AdminModal
      ...
      onClose={onClose}
      onSave={handleSubmit}
      title={initialData ? 'Dergi Düzenle' : 'Yeni Dergi Ekle'}
      description={initialData ? 'Mevcut dergi sayısını düzenleyin' : 'Yeni bir dergi sayısı ekleyin'}
      icon={<FileText className="w-6 h-6 text-white" />}
      isSaving={loading || isUploading}
          ...
          <div className="text-sm text-orange-700 dark:text-orange-300 space-y-2">
            ...
            <div className="bg-orange-100 dark:bg-orange-900/50 p-3 rounded border border-orange-200 dark:border-orange-700">
              ...
              <div className="space-y-1">
                <p>• <a href="https://smallpdf.com/compress-pdf" target="_blank" rel="noopener noreferrer" className="text-blue-600 dark:text-blue-400 underline">SmallPDF</a> - En popüler</p>
                <p>• <a href="https://www.ilovepdf.com/compress_pdf" target="_blank" rel="noopener noreferrer" className="text-blue-600 dark:text-blue-400 underline">ILovePDF</a> - Güçlü sıkıştırma</p>
                <p>• <a href="https://tools.pdf24.org/compress-pdf" target="_blank" rel="noopener noreferrer" className="text-blue-600 dark:text-blue-400 underline">PDF24</a> - Ücretsiz</p>
              </div>
            </div>
